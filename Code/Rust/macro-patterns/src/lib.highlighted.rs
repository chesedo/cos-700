...
pub fn abstract_factory(tokens: TokenStream, |\contexth{trait\_expr}|: TokenStream) -> TokenStream {
    let mut input = parse_macro_input!(|\contexth{trait\_expr}| as ItemTrait);
