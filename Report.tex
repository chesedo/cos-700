...
Three definitions will be explored to understand Rust better.
...
\paragraph{Struct}
A \textit{struct} is the same as a \textit{struct} in C and other C like languages.
...
\embed[lastline=44]{Example of a Struct}{Rust/oop}
...
Rust \textit{trait}s cause it to meet both requirements allowing Rust to implement the Gang of Four design patterns.
