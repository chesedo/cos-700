...
\Fref{lst:Rust/function-like-macro} shows a reflective function-like macro that returns its input unaltered as output.
...
These macros are used to add methods to objects as seen in \Fref{lst:Rust/derive-macro}.
...
This time the attribute above the function is \textit{proc\_macro\_attribute} as seen in \Fref{lst:Rust/attribute-macro}.
