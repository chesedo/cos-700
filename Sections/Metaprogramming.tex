...
The object code will be interleaved with the metaprogram making it hard to distinguish between them, making it easy to construct a string that is not syntactically correct.
