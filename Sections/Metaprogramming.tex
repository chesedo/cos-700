...
Derive macros have the \textit{proc\_macro\_derive} attribute followed by the macro \functionh{name} as seen on line 3.
The \inputh{input} on line 4 is the context the macro is called on.
