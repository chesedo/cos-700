...
\libraryCodeFromFile{function-like-macro/src/main.rs}{function-like-macro}{Declaring a function-like macro}
...
This call has the same \colorbox{function}{function name} as the macro.
...
These macros are used to add methods to objects as seen in \Fref{lst:derive-macro}.

\libraryCodeFromFile[firstline=4]{derive-macro/src/main.rs}{derive-macro}{A derive macro using \textit{syn} and \textit{quote}}
...
\libraryCodeFromFile[firstline=4]{attribute-macro/src/main.rs}{attribute-macro}{Declaring an attribute macro}
...
The \colorbox{input}{attribute input} is the first stream passed to the function, while the \colorbox{context}{context} is the second.
