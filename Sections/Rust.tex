...
\begin{itemize}
	\item The method \textit{have\_burial} moves \textit{self} and will result in cleanup code being inserted in line 18.
	      ...
	      This happens in line 33, resulting in a compile error -- the same error happened in \Fref{lst:fn-move}.
...
% TODO: trim line spaces in listing
...
\addtocounter{footnote}{1}\footnotetext{%
	...
	They are used as constructors by returning an owned instance of the struct, as seen in line 39.
}
