...
Thus, \textit{traits} allow the definition of abstract behavior to program to an interface, as seen in \Fref{lst:traits}, lines 1 to 8.

\exampleCodeFromFile[lastline=20]{traits/src/main.rs}{traits}{Working with traits}
...
\exampleCodeFromFile[firstline=22,lastline=27]{traits/src/main.rs}{monomorphization}{Example of \textit{monomorphization}}
