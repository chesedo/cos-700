...
In \Fref{lst:traits}, line 10, the generic \textit{work} method is defined.
Suppose the \textit{work} method is called with a \textit{Tester}, defined on line 28, and later with a \textit{String}.
Then an example of the \textit{monomorphization} process is shown in \Fref{lst:monomorphization}.
