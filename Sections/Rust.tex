...
\exampleCodeFromFile[firstline=2,lastline=7]{moved/src/main.rs}{moved}{Example of ownership transfer}
...
\exampleCodeFromFile{fn-move/src/main.rs}{fn-move}{Function taking ownership}
...
\exampleCodeFromFile{fn-borrow/src/main.rs}{fn-borrow}{Function taking borrow}
...
As seen in \Fref{lst:fn-mut-borrow}, mutable borrows are activated using \textit{\&mut } on the type.
...
\exampleCodeFromFile[lastline=44]{oop/src/main.rs}{oop}{Example of a Struct}

\paragraph{Methods}
The operations to perform on a struct are defined in an \textit{impl} block, as seen in lines 7 - 19 in \Fref{lst:oop}.
