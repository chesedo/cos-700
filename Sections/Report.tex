...
The AF macro is shown in \Fref{lst:abstract-factory-macro} to be an attribute macro as defined in \Fref{sec:attribute-macro}.
...
Line 6 parses the macro inputs to a list of \textit{TraitSpecifier}s defined in \Fref{lst:trait-specifier}.
...
Four token types were presented in \Fref{lst:function-like-macro}.
...
\Fref{lst:trait-specifier-interpolate} shows interpolation being implemented for \textit{TraitSpecifier} -- specified in \Fref{lst:trait-specifier}.
