...
\begin{itemize}
	\item The abstract visitor, as defined on lines 3 to 14, maps to the UML for visitor, as defined in \Fref{sec:design-visitor}.
...
Because the default implementation in \Fref{lst:visitor-hand} line 12 uses the helper on line 27, \textit{VisitorName} does not need to implement anything for \textit{Window} to traverse into a \textit{Window}'s children.
...
It parses the \textit{\#[list-of-KeyValues]} stream, as defined on lines 8 to 12.
