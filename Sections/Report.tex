...
\libraryCodeFromFile[firstline=5,lastline=17]{macro-client/src/abstract_factory_hand.rs}{abstract-factory-hand}{Manual abstract factory}
...
\libraryCodeFromFile[firstline=5,lastline=62]{macro-client/src/visitor_hand.rs}{visitor-hand}{Manual visitor}
...
The \textit{expand} method for the \textit{AbstractFactoryAttribute} model is defined as seen in \Fref{lst:abstract-factory-attribute-expand}.
...
\libraryCodeFromFile[lastline=27]{macro-lib/src/annotated_type.rs}{annotated-type}{Parses an annotated type}
